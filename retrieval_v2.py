"""
M3 retrieval: FTS, semantic (embedding), and hybrid search over Log entries.
...
def embed_all_logs(con: sqlite3.Connection, client: OpenAI) -> int:
    ...
    """
    from db_v2 import get_logs_without_embeddings, store_embedding
...
def semantic_search(
    ...
    """
    from db_v2 import load_all_embeddings
...
def entity_search(
    ...
    Uses the M2 EntityReference layer — no LLM call needed.
    """
    from promote_v2 import find_entity
